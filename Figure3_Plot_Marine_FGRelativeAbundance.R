#Plotting output for Figure 3 - Marine FG Relative Abundance 
...
fgcols <- read.csv('Datasets/tj_relabund_marinecols.csv')
...
#edit periods and stages from deeptime package
