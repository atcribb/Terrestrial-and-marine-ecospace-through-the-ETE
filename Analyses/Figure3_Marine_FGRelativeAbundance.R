...
write.table(fg_table, file='Output/marine_fgtable.txt')
...
#get n.colls occurrences (400 for marine)
...
save(relabund_occs_df, file='Output/marine_relabund_occs_df.RData')

#==== now the same thing for generic richness ====#
...
colSums(relabund_genrich_df) #should all = 1

save(relabund_genrich_df, file='Output/marine_relabund_genrich_df.RData')
