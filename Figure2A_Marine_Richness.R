#analysis of generic and functional richness - marine
...
#2 - sample coll.n (400) collections
...
collsubgendiv.final$age_mid <- stages$mid[56:63]
...
collsubfuncdiv.final$age_mid <- stages$mid[56:63]
collsubfuncdiv.final <- calc.quantiles(collsubsample.funcdiv, TJ_stages, collsubfuncdiv.final)
collsubfuncdiv.final


#SAVE DATA!
save(collsubgendiv.final, file='Output/marine_collsubbed_genericrichness.RData')
save(collsubfuncdiv.final, file='Output/marine_collsubbed_functionalrichness.RData')
